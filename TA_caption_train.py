...
if __name__ == '__main__':
    ...
    # CBS ARGS
    parser.add_argument('--cbs', type=str, default='True')
    ...
    parser.add_argument('--std_factor', default=0.985, type=float)  # log_std_factor: 0.985  # gau_Std_factor: 0.9
    
    parser.add_argument('--cbs_filter', default='LOG', type=str) # Potential choice: 'gau' and 'LOG'

    args = parser.parse_args()
    print(args)
    print('ls',args.ls)
    print('cbs',args.cbs)
    print("cbs_filter:", args.cbs_filter) 
    ...
    for e in range(start_epoch, start_epoch + 50):  
        ...
        ################################   CBS  #################################
        if args.cbs == 'True':
            model.encoder.get_new_kernels(e, args.kernel_sizex, args.kernel_sizey, args.decay_epoch, args.std_factor, args.cbs_filter) 
