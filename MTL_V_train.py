...
if __name__ == "__main__":
    ...
    if domain_adaptation == 'DA':
        ...
        elif load_checkpoint_domain == 'DA':
            # Target domain incremental domain adaption pre-trained checkpoint weights    
            parser.add_argument('--fe_modelpath',          type=str,       default='feature_extractor/checkpoint/incremental/inc_ResNet18_SC_CBS_0_012345678910.pkl')

    parser.add_argument('--mtl_version',           type=str,       default='MTL_V_UDA_SC_CBS')
    ...
    # # loading pre-trained SD weights when training for few-shot domain adaptation
    # pretrained_model = torch.load('checkpoints/mtl_train/MTL_V_DA_SD_SC_CBS/best_caption.pth')
    # model.load_state_dict(pretrained_model['state_dict'])
    
    '''================================= initial model evaluation ================================'''
    eval_mtl(model, dict_dataloader_val, text_field)

    '''Train MTL model from scratch'''
