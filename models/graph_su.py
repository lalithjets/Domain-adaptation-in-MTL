...
configurations of the network
    Feature_size = 512
    readout: G_ER_L_S = [Feature_size+300+16+300+Feature_size,  Feature_size, 117]

    node_func: G_N_L_S = [Feature_size+Feature_size, Feature_size]
    node_lang_func: G_N_L_S2 = [300+300+300]
    
    edge_func : G_E_L_S = [Feature_size*2+16, Feature_size]
    edge_lang_func: [300*2, Feature_size]
    
    attn: [Feature_size, 1]
    attn_lang: [Feature_size, 1]
'''
